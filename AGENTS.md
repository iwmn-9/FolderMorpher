...
> ⚠️ **後続のAIメンテナへ**:
> 本プロジェクトの全 94 項目に及ぶ詳細な設計判断記録（ADR 1〜94）は、トークン消費削減および可読性維持のため [`.agents/ADR.md`](.agents/ADR.md) に体系化・外部保管されている。
