...
internal static class LinkFixDtoMapper
{
    ...
    public static LinkFixItem ToCore(ShortcutLinkDto dto) => new()
    {
        ...
        AssociatedOfficeItem = dto.AssociatedOfficeItem == null ? null : ToCore(dto.AssociatedOfficeItem)
    };
    ...
    public static OfficeLinkItem ToCore(OfficeLinkDto dto) => new()
    {
